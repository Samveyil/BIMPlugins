...
namespace BIMPlugins.Tests
{
    ...
    public class CreateColumnsFromPanelsCmd : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var famSymbol = new ElementId(26823540).ToElement<FamilySymbol>();
            ...
            var panels = RevitAPI.UIDocument.Selection.PickObjects(ObjectType.LinkedElement)
            ...
            using (Transaction t = new Transaction(doc, "Создать фахверк"))
            {
                ...
                foreach (var panel in panels)
                {
                    ...
                    var translation = panelFaceOrient * (46 + 400) * intUnit;
                    ...
                    //ExMethods.CreateDirectShape([centerLine.CreateTransformed(transform)]);
                    //ExMethods.CreateDirectShape([colAxis]);
